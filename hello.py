...
def home():
    ...
    return render_template('index.html',params=params,posts=posts,post=post,prev=prev,next=next)
...
def contact():
    if (request.method=="POST"):
        ...
        entry=Contacts(name=name,email=email,phone_no=phone_no,msg=msg,date=datetime.now())
